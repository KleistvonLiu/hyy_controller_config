...
* @return int 成功返回0，错误返回其他
*/
int JSFCSetJointDragParam(const char* name, double* K);

/**
* @brief 设置减速机传动效率
*
* @param name 创建时指定的名称
* @param tran_effic 传动效率 0~1
* @return int 成功返回0，错误返回其他
*/
int JSFCSetJointTranEfficParam(const char* name, double* tran_effic);
